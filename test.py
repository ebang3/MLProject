...
def handle_classification_task(train_data_file, train_label_file, test_data_file, output_directory, output_filename, test_label_file=None):
    # Step 1: Load the data
    train_data, train_labels, test_data, test_labels = load_data(train_data_file, train_label_file, test_data_file, test_label_file)
